...
const PRODUCTION_APPOINTMENT_SELECT =
  'id, organization_id, created_by_profile_id, short_id, customer_name, customer_phone_optional, vehicle, vin_optional, vehicle_image_url, vehicle_image_provider, video_status, video_url, video_thumbnail_url, video_share_page_url, video_requested_at, video_completed_at, video_error, appointment_time, salesperson_name, salesperson_title, salesperson_avatar_url, dealership_name, dealership_address, public_url, created_at, opened_at, confirmed_at, reschedule_requested_at, reschedule_note, status';
